...
- 📊 **Visual Time Blocking:** Events displayed with dynamic heights based on duration
- 🔄 **Simultaneous Events:** Multiple events at the same time shown side-by-side
- 🎯 **Enhanced UI:** Improved month view grid layout and better visual contrast

---

### Version 0.002 (2025-11-30)
**Status:** ✅ Stable
